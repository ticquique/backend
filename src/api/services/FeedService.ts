...
export class FeedService {
    ...
    // tslint:disable-next-line:max-line-length
    public findAction = (page: number = 1, perPage: number = 20, resource?: string | FindAction, sort?: string, filter?: string, partial?: boolean, populate?: any[] | any): Promise<IActionModel[]> => {
    ...
    public create = (feed: IFeedModel, userId?: string, populate?: string): Promise<IFeedModel> => {
        return new Promise<IFeedModel>((resolve, reject) => {
            ...
            this.findAction(1, 350, null).then(actions => {
    ...
    public createAction = (action: IActionModel, userId?: string, populate?: string): Promise<IActionModel> => {
        return new Promise<IActionModel>((resolve, reject) => {
